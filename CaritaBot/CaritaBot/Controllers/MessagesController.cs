...
namespace CaritaBot
{
    ...
    public class MessagesController : ApiController
    {
        ...
        public async Task<Message> Post([FromBody]Message message)
        {
            if (message.Type == "Message")
            {
                ...
                {
                    return message.CreateReplyMessage("Enviame una Foto!");
                }
    ...
    public static class Utilities
    {
        public static async Task<string> CheckEmotion(string query)
        {
            ...
            // Request headers
            client.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", "42773e9113ac4bf0a8f4f4f0f75e665e");
            ...
            if (faces.Count() > 0)
            {
                ...
                Tuple.Create(r.scores.surprise,"Surprise"),
                    ...
                    responseMessage += $"![{emotion}](https://karita.azurewebsites.net/{emotion}.png)";
                }
            }
            else
            {

                responseMessage = "Ninguna Cara detectada";
            }
